...
class Metric(YAMLable):
    ...
    def add(self, reference, outputs):
        ...
        Arguments:
            ...
            outputs (neon.backend.Tensor): Predicted outputs.
    ...
    def report(self, retval):
        """
        Report this metric's current calculated value(s).

        Arguments:
            retval (neon.backend.Tensor): Where to store the calculated values.

        Returns:
            Tensor: reference to retval
