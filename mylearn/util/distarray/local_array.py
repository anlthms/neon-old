...
class LocalArray(object):
    ...
    def compute_halo_insert_indices(self):
        ...
        neighbor_traverse_order1 = [7, 0, 4]
        neighbor_traverse_order2 = [3, 8, 1]
        neighbor_traverse_order3 = [6, 2, 5]
        c_ptr = 0
        d_ptrs = dict()
